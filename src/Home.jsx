...
import { FaPlaneDeparture, FaBookReader } from "react-icons/fa";
  ...
  return (
    <>
      <Box
        h={"70vh"}
        backgroundImage={
          "https://github.com/xdashutosh/images/blob/main/Engineer.jpg?raw=true"
        }
      ...
      >
        <Stack direction={["column", "row"]} w={"full"} h={"full"}>
          ...
          >
            <div
              className={`text-container ${loaded ? "loaded" : ""}`}
              style={{ fontFamily: "fantasy" }}
            >
              <span
                className={`reg-text ${loaded ? "loaded" : ""}`}
                style={{ margin: "15px" }}
              >
                I'M
              </span>
              <span className={`letter ${loaded ? "loaded" : ""}`}>A</span>
              <span className={`letter ${loaded ? "loaded" : ""}`}>S</span>
              <span className={`letter ${loaded ? "loaded" : ""}`}>H</span>
              <span className={`letter ${loaded ? "loaded" : ""}`}>U</span>
              <span className={`letter ${loaded ? "loaded" : ""}`}>
                <b>.</b>.
              </span>
            </div>
          </VStack>
      ...
      <HStack  display={['none','flex']} w={'full'}  justifyContent={'space-around'} textColor={'white'} p={'8'} bgColor={'#05001d'} fontSize={'xl'}>
        <Text >support@ ashuchaudhary6969@gmail.com</Text>
       ...
       <a href="https://www.reddit.com/user/xdashutosh/" target="blank">
         <BsReddit className='Arrowright'/>
        </a>
        <a href="https://github.com/xdashutosh" target="blank">
